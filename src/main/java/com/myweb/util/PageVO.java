...
public class PageVO {
	...
	private int startPage; //시작하는페이지번호
	...
	public PageVO(int pageNum, int amount, int total) {
		...
		//현재조회하는 번호가 1~10 -> 10
		//현재조회하는 번호가 11~20 -> 20
		//공식: (int)Math.ceil(페이지번호 / 화면에보여질 데이터수) * 화면에보여질 데이터수
		...
		//11번페이지 클릭 -> endPage = 20, realEnd = 14 (14)
		...
		//6. next버튼 활성화 여부
		//예시 : 131개 게시물
		//1~10번 까지는 endPage = 10; realEnd= 14(true)
